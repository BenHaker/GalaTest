...
var HomePage = (function () {
    ...
    HomePage.prototype.submit = function () {
        ...
        this.httpClient.post("http://localhost:3000/", this.data).subscribe(function (data) {
            _this.errorMessage = data.error;
            _this.data.url = data.url;
            //Redirect to the URL the user inserted
            if (_this.errorMessage == "" && _this.data.isRedirect == false)
                window.open(_this.data.url, "_self");
        });
    };
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"E:\Projects\Galaprompter\ClientApp\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Galaprompter Test App\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <div>\n      <ion-list>\n        <ion-item>\n          <ion-input type="url" [(ngModel)]="data.url" placeholder="Please Insert URL"></ion-input>\n        </ion-item>\n        <ion-item>\n          <ion-label>Redirect</ion-label>\n          <ion-checkbox [(ngModel)]="data.isRedirect"></ion-checkbox>\n        </ion-item>\n      </ion-list>\n      <button ion-button (click)="submit()">Submit</button>\n    <h3>{{ errorMessage }}</h3>\n    <h3 *ngIf="data.isRedirect">URL: {{ data.url }}</h3>\n  </div>\n</ion-content>\n'/*ion-inline-end:"E:\Projects\Galaprompter\ClientApp\src\pages\home\home.html"*/
        }),
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"E:\Projects\Galaprompter\ClientApp\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"E:\Projects\Galaprompter\ClientApp\src\app\app.html"*/
        }),
